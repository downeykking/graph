...
class GCN(nn.Module):
    def __init__(self, input_dim, hidden, output_dim, dropout=0.5):
        ...
        self.conv1 = GCNConv(in_channels=input_dim, out_channels=hidden)
        self.conv2 = GCNConv(in_channels=hidden, out_channels=output_dim)
...
model = GCN(input_dim=dataset.num_node_features, hidden=16,
