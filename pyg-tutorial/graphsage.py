...
class GSAGE(nn.Module):
    def __init__(self, input_dim, hidden, output_dim, dropout=0.5):
        ...
        self.conv1 = SAGEConv(in_channels=input_dim, out_channels=hidden)
        self.conv2 = SAGEConv(in_channels=hidden, out_channels=output_dim)
...
model = GSAGE(input_dim=dataset.num_node_features, hidden=16,
